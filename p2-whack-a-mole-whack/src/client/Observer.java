...
public interface Observer< Subject > {
    ...
    /**
     * The observed subject calls this method on each whack.observer that has
     * previously registered with it. This version of the design pattern
     * follows the "push Model" in that typically the whack.observer must
     ...
     * or if it can safely be assumed that the whack.observer already has a
