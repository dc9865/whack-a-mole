 ...
 * messages that are communicated between the whack.server and the
 * clients.<br>
 *
...
public interface WAMProtocol {
    /**
     * From whack.server: sent to the client after the client
     * initially opens a {@link java.net.Socket} connection to the whack.server.<br>
    ...
    /**
     * From whack.server: inform client that a mole has popped up.<br>
     *     One argument: the mole number
     */
    public static final String MOLE_UP = "MOLE_UP";

    /**
     * From whack.server: inform client that a mole has dropped down.
     * This message is sent even if it was whacked or if the game whack.server
    ...
    /**
     * From client: inform whack.server that it has whacked a mole.
     * (Game whack.server must then decide if a mole was really up at that
    ...
    /**
     * From whack.server: client is informed of every player's score.<br>
    ...
    /**
     * Message sent from the whack.server to the client when the client has won the
     * game.
     */
    public static final String GAME_WON = "GAME_WON";

    /**
     * Message sent from the whack.server to the client when the client has lost the
     * game.
     */
    public static final String GAME_LOST = "GAME_LOST";

    /**
     * Message sent from the whack.server to the client when the client has tied with
     * others in the game to win.
     */
    public static final String GAME_TIED = "GAME_TIED";

    /**
     * Request sent from the whack.server to the client when any kind of error has
